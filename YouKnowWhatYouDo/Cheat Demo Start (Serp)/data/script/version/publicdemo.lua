-- Cant change too much here compared to original, otherwise new game button wont work
-- So only prevent disabling the worldmap and SetWarDeclarationAllowed/SetRebellionDisabledState
...
RuntimeSettings:BlockUIState("OnlineStatus")
...
if isNewGame then 
    ...
    GameSetup.CurrentGameSetup.GameSeed = 42
end
